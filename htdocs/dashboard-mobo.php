<?php
  ...
  if(isset($_POST['bSimpan']))
  {
    //action saat edit
    if($_GET['hal'] == "edit") {
      $edit = mysqli_query($koneksi,"UPDATE mobo set id_mobo='".$_POST['tiD']."',
      nama = '".$_POST['tNama']."', 
      cat = '".$_POST['tCat']."',
      detail = '".$_POST['tDetail']."',
      harga = '".$_POST['tHarga']."' WHERE id_mobo = '".$_GET['id']."'
      ");
    }
    //action simpan biasa
    else { $simpan = mysqli_query($koneksi, "INSERT INTO mobo (id_mobo, nama, cat, detail, harga) 
  ...
  if(isset($_GET['hal'])) {
    //action button edit
    if ($_GET['hal'] =='edit') {
      $tampil = mysqli_query($koneksi, "SELECT * FROM mobo WHERE id_mobo = '$_GET[id]'");
    ...
    //action hapus
      ...
      $hapus = mysqli_query($koneksi, "DELETE FROM mobo WHERE id_mobo = '$_GET[id]'");
    }
  }
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><a href="dashboard-mobo.php"></i>Motherboard</a></li>
            ...
            <div class="card mt-3" id="Table">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <?php
                    $tampil = mysqli_query($koneksi, "SELECT * from mobo order by id_mobo desc");
                  ...
                  <tr>
                    ...
                    <td><?=$data['harga']?></td>
                    <td>
                      <a href="dashboard-mobo.php?hal=edit&id=<?=$data['id_mobo']?>" class="btn btn-warning">Edit</a>
                      <a href="dashboard-mobo.php?hal=hapus&id=<?=$data['id_mobo']?>"
