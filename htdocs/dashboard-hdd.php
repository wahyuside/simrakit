<?php
  ...
  if(isset($_POST['bSimpan']))
  {
    //action saat edit
    if($_GET['hal'] == "edit") {
      $edit = mysqli_query($koneksi,"UPDATE hdd set id_hdd='".$_POST['tiD']."',
      nama = '".$_POST['tNama']."', 
	  cat = '".$_POST['tCat']."',
	  detail = '".$_POST['tDetail']."',
      harga = '".$_POST['tHarga']."' WHERE id_hdd = '".$_GET['id']."'
      ");
    }
    //action simpan biasa
    else { $simpan = mysqli_query($koneksi, "INSERT INTO hdd (id_hdd, nama, cat, detail, harga) 
  ...
  if(isset($_GET['hal'])) {
    //action button edit
    if ($_GET['hal'] =='edit') {
      $tampil = mysqli_query($koneksi, "SELECT * FROM hdd WHERE id_hdd = '$_GET[id]'");
    ...
    //action hapus
      ...
      $hapus = mysqli_query($koneksi, "DELETE FROM hdd WHERE id_hdd = '$_GET[id]'");
    }
  }
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
			...
			<li class="active"><a href="dashboard-hdd.php"></i> HDD</a></li>
            ...
            <div class="card mt-3" id="Table">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <?php
                    $tampil = mysqli_query($koneksi, "SELECT * from hdd order by id_hdd desc");
                  ...
                  <tr>
                    ...
                    <td><?=$data['harga']?></td>
                    <td>
                      <a href="dashboard-hdd.php?hal=edit&id=<?=$data['id_hdd']?>" class="btn btn-warning">Edit</a>
                      <a href="dashboard-hdd.php?hal=hapus&id=<?=$data['id_hdd']?>"
