<?php
  ...
  if(isset($_POST['bSimpan']))
  {
    //action saat edit
    if($_GET['hal'] == "edit") {
      $edit = mysqli_query($koneksi,"UPDATE ram set id_ram='".$_POST['tiD']."',
      nama = '".$_POST['tNama']."', 
	  detail = '".$_POST['tDetail']."',
      cat = '".$_POST['tCat']."',
      harga = '".$_POST['tHarga']."' WHERE id_ram = '".$_GET['id']."'
      ");
    }
    //action simpan biasa
    else { $simpan = mysqli_query($koneksi, "INSERT INTO ram (id_ram, nama, detail, cat, harga) 
                                     VALUES('$_POST[tiD]', '$_POST[tNama]', '$_POST[tDetail]',  '$_POST[tCat]', '$_POST[tHarga]')"
                                     );}
  }
  ...
  if(isset($_GET['hal'])) {
    //action button edit
    if ($_GET['hal'] =='edit') {
      $tampil = mysqli_query($koneksi, "SELECT * FROM ram WHERE id_ram = '$_GET[id]'");
    ...
    //action hapus
      ...
      $hapus = mysqli_query($koneksi, "DELETE FROM ram WHERE id_ram = '$_GET[id]'");
    }
  }
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
			...
			<li class="active"><a href="dashboard-ram.php"></i> RAM</a></li>
            ...
            <div class="card mt-3" id="Table">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <?php
                    $tampil = mysqli_query($koneksi, "SELECT * from ram order by id_ram desc");
                  ...
                  <tr>
                    ...
                    <td><?=$data['harga']?></td>
                    <td>
                      <a href="dashboard-ram.php?hal=edit&id=<?=$data['id_ram']?>" class="btn btn-warning">Edit</a>
                      <a href="dashboard-ram.php?hal=hapus&id=<?=$data['id_ram']?>"
